...
// Ham dem so lupng dang kiem theo ngay dang kiem va khu vuc
async function timeNumberFilter(registration_information, center_information, year, quarter, center_id, province, area) {
    let dem = [];
    let kq = [];
    let dates_issued = [];
    let timeline = [];
...
module.exports = timeNumberFilter;